package com.example.lab08.Helper;
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if(viewHolder != null){
            if (this.listener.getClass().getSimpleName().equals("MainActivity")) {
                backgroundViewEdit = ((UsuarioAdapter.MyViewHolder) viewHolder).viewBackgroundEdit;
                backgroundViewDelete = ((UsuarioAdapter.MyViewHolder) viewHolder).viewBackgroundDelete;
                foregroundView = ((UsuarioAdapter.MyViewHolder) viewHolder).viewForeground;
            }
